...
from libero.lifelong.models.base_policy import BasePolicy, REGISTERED_POLICIES

class ExtraModalityTokens(nn.Module):
    def __init__(self, use_joint=False, use_gripper=False, use_ee=False, extra_num_layers=0,
                 extra_hidden_size=32, extra_embedding_size=16):
        """
        This class maps all extra modality inputs into tokens of the same size.
        """
        super().__init__()
    ...
    def forward(self, obs_dict):
        ...
        Maps the above to a latent vector of shape (B, T, H)
        """
        tensor_list = []
...
class MyBCTransformerPolicy(BasePolicy):
    """
