...
class MyTrainer:
    ...
    def train(self, run_num, checkpoint_dir, resume_args=None, n_epochs=5):
        ...
        for i in trange(self.benchmark.n_tasks):
            ...
            self.algo.train()
            s_fwd, l_fwd, resume_args = self.algo.learn_one_task(self.datasets[i], i, self.benchmark, self.result_summary, resume_args)
