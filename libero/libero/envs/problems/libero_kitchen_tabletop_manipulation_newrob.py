...
@register_problem
class LIBERO_Kitchen_Tabletop_Manipulation_NewRob(BDDLBaseDomain):
    def __init__(self, bddl_file_name, *args, **kwargs):
        ...
        # This is the old code. I'm honestly not sure where this is called other than in creation tbh
        #kwargs.update(
